level_0 = {
    ...
    'enemies': './level/0/level_0._enemy.csv',
    'constraints': './level/0/level_0._constraints.csv',
    'player': './level/0/level_0._player.csv',
...
level_1 = {
    ...
    'fg palms': './level/1/level_1_fg_trees.csv',
    'bg palms': './level/1/level_1_bg_trees.csv',
    'enemies': './level/1/level_1_enemy.csv',
    'constraints': './level/1/level_1_enemy_limits.csv',
    'grass': './level/1/level_1_grass.csv',
    'crates': './level/1/level_1_crate.csv',
    'player': './level/1/level_1_player.csv',
    'wind_turbines': './level/1/level_1_wind_turbines.csv',
    'node_pos': (600, 560),
